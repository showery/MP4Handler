 ...
 */
    ...
    public:
        ...
        void SetFrame(unsigned char *pbyData, int nWidth, int nHeight,unsigned long long uTimestamp, s32 nDir, BOOL32 bIsFrontCamera);
        ...
        void bindEvent(NewFrameCB cbOnNewFrame,void *cbDelegate);
    ...
    inline BOOL32 CRenderer::IsEmptyFrame() {
        return m_tFrame.pbyData == 0 || m_tFrame.nWidth == 0 || m_tFrame.nHeight == 0;
    }
